Contributing to LRMcoin Core
============================

The LRMcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LRMcoin Core project, and is not to be
confused with overall LRMcoin Network Protocol consensus changes.

Whether a pull request is merged into LRMcoin Core rests with the project merge
...
Patches that change LRMcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the LRMcoin consensus, it must have been
...
The project leader is the release manager for each LRMcoin Core release.
