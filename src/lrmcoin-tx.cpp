...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lrmcoin Core lrmcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lrmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lrmcoin transaction") + "\n" +
                               "  lrmcoin-tx [options] -create [commands]   " + _("Create hex-encoded lrmcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lrmcoin transaction
