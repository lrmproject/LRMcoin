...
#ifndef LRMcoin_STAKEINPUT_H
#define LRMcoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZLRM() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zLRMStake can take two forms
...
public:
    ...
    bool IsZLRM() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZLRM() override { return false; }
};


#endif //LRMcoin_STAKEINPUT_H
