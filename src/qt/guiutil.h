...
/** Utility functions used by the LRMcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render LRMcoin addresses in monospace font
...
// Parse "lrmcoin:" URI into recipient object, return true on successful parsing
