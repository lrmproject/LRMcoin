                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LRMcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LRMcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lrmcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLRM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LRMcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about LRMcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LRMcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LRMcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LRMcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a LRMcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LRMcoin Core help message to get a list with possible LRMcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LRMcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LRMcoin network", "", count));
}
...
{
    QString strTitle = tr("LRMcoin Core"); // default title
