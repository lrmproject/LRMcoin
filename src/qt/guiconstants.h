...
/* Lrmcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LRMcoin"
#define QAPP_ORG_DOMAIN "lrmcoin.cc"
#define QAPP_APP_NAME_DEFAULT "LRMcoin-Qt"
#define QAPP_APP_NAME_TESTNET "LRMcoin-Qt-testnet"
