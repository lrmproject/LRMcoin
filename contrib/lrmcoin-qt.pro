...
RESOURCES += src/qt/lrmcoin.qrc src/qt/lrmcoin_locale.qrc

TRANSLATIONS += src/qt/locale/lrmcoin_bg.ts \
                src/qt/locale/lrmcoin_de.ts \
                src/qt/locale/lrmcoin_en.ts \
                src/qt/locale/lrmcoin_es.ts \
                src/qt/locale/lrmcoin_fi.ts \
                src/qt/locale/lrmcoin_fr.ts \
                src/qt/locale/lrmcoin_it.ts \
                src/qt/locale/lrmcoin_ja.ts \
                src/qt/locale/lrmcoin_pl.ts \
                src/qt/locale/lrmcoin_pt.ts \
                src/qt/locale/lrmcoin_ru.ts \
                src/qt/locale/lrmcoin_sk.ts \
                src/qt/locale/lrmcoin_sv.ts \
                src/qt/locale/lrmcoin_vi.ts \
                src/qt/locale/lrmcoin_zh_CN.ts \
                src/qt/locale/lrmcoin_zh_TW.ts
