...
In order to support loading of multiple wallets in lrmcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lrmcoin.cpp.
...
Changes to lrmcoin.cpp
----------------------
lrmcoin.cpp is the entry point into lrmcoin-qt, and as such, will require some minor modifications to provide hooks for
